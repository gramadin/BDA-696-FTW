...
drop table if exists rolling_180;
create table rolling_180 as	
select
	tbc1.team_id
	...
	JOIN game g2 ON g2.game_id = tbc2.game_id AND
		...
		g2.local_date >= DATE_ADD(gl.local_date, INTERVAL -180 DAY)
	GROUP BY tbc1.team_id, tbc1.game_id , gl.local_date
	ORDER BY gl.local_date, tbc1.team_id;
# Establish Index
CREATE UNIQUE INDEX team_game ON rolling_180 (team_id, game_id);