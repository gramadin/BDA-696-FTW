...
select batter_counts.game_id , batter , plateApperance , toBase, left(game.local_date,10) as Game_Date, (toBase/nullif(plateApperance,0)) as game_bat_avg
from batter_counts 
...
select batter, avg(game_bat_avg) as hist_avg from game_player  group by batter;
